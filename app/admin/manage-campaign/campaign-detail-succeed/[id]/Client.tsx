...
// เพิ่ม type ให้ global window สำหรับฟังก์ชัน handleDonationAllChange, addCommas และ addCommasWish
declare global {
  interface Window {
...
const Client: React.FC<ClientProps> = ({ initial }) => {
  ...
  // กำหนด state โดยใช้ initial จาก props
  ...
  // กำหนดฟังก์ชัน global บน window สำหรับ addCommas และ addCommasWish
              ...
              {campaigns.map((campaign, index) => (
                <tr key={campaign.id} className=" hover:bg-gray-100 transition">
                  ...
                  <td className="p-4 text-nowrap truncate-text">
                    {campaign.detailsname && !campaign.detailsbirthdate ? campaign.detailsname : ""}
                    {campaign.detailsname && campaign.detailswish ? campaign.detailsname : ""}
                    ...
                    {campaign.detailstext ? campaign.detailstext : ""}
                    {campaign.details ? campaign.details : ""}
                  </td>
                  <td className="p-4 text-nowrap truncate-text">
                    {campaign.detailswish ? campaign.detailswish : ""}
                  </td>
